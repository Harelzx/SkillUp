...
export default function OnboardingScreen() {
  ...
  const slides: OnboardingSlide[] = [
    ...
    },
    {
      ...
      description: 'קיים שיעורים פרונטליים בזמנים הנוחים לך. טכנולוגיה מתקדמת לחווית למידה מיטבית.',
    },
    {
      id: '3',
      icon: Star,
      title: 'השג תוצאות מעולות',
      description: 'עקוב אחר ההתקדמות שלך, קבל משוב אישי, ותבנה מערכת יחסים עם המורים הטובים ביותר.',
    },
  ];
